...
class PatternParser (WaxeyeParser):
    start = 0
    eof_check = True
    automata = [FA("document", [State([Edge(16, 1, False)], False),
            State([], True)], FA.PRUNE),
        ...
        FA("wordB", [State([Edge(13, 1, False)], False),
            State([], True)], FA.LEFT),
        FA("exprA", [State([Edge(12, 1, False)], False),
            State([Edge(8, 1, False),
                Edge(22, 1, False),
                Edge(32, 1, False),
                Edge(28, 1, False),
                Edge(30, 1, False),
            ...
            State([], True)], FA.LEFT),
        FA("exprB", [State([Edge(12, 1, False)], False),
            State([Edge(8, 1, False),
                Edge(22, 1, False),
                Edge(32, 1, False),
                Edge(29, 1, False),
